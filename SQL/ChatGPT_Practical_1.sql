...
VALUES
(1,'Abhay',19,'Chemical Engineering','odysseusnitw753@gmail.com', 'A'),
(2,'Anshuman',20,'Chemical Engineering','as23chb0a03@student.nitw.ac.in','B'),
(3,'Riya',18,'Computer Science',NULL,'A'),
(4,'Aarav',21,'Mechanical Engineering',NULL,'C'),
(5,'Meera',19,'Chemical Engineering','meera_ce@nitw.ac.in','B');
...
WHERE RollNo=4;
SAVEPOINT Step2;
TRUNCATE TABLE Students; -- Will Not Rollback
ROLLBACK TO Step1;
-- DCL PRACTICE
SELECT * FROM Students WHERE Age>19;
SELECT * FROM Students WHERE Course LIKE '%Eng%';
